       ...
       <Tabs>
         ...
         <View title="HOME" style={styles.content}>
           ...
           <Text style={styles.text}>
             This is where Tutor would see their scheduled appointments
           </Text>
         </View>
         {/* Second tab */}
         <View title="REQUESTS" style={styles.content}>
           <Text style={styles.header}>
             Find Tutees
           </Text>
           <Text style={styles.text}>
             This is where one would find list of parent requests.
           </Text>
         </View>
         {/* Third tab */}
